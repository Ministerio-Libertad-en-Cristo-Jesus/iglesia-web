...
const SearchBar = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex justify-end w-full">
      ...
      value={searchText}
      placeholder="Buscar"
      className={`text-sm md:text-base appearance-none outline-none w-full sm:w-[40%] rounded-l-lg rounded-r-none border-y border-l md:border-y-2 md:border-l-2 border-l-blueI border-y-blueI py-1 pl-1 md:py-2 md:pl-2 text-blueI bg-white transition-all duration-200`}
      type="search" />
